...
namespace ClientControl_LagunaDelMar.DataLayer {
    ...
    public partial class DSSettings : global::System.Data.DataSet {
        ...
        public partial class SettingsDataTable : global::System.Data.TypedTableBase<SettingsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public SettingsRow AddSettingsRow(int Id, string settingName, string value) {
            ...
            public string settingName {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'settingName\' in table \'Settings\' is DBNull.", e);
                    }
                }
                set {
...
namespace ClientControl_LagunaDelMar.DataLayer.DSSettingsTableAdapters {
    ...
    public partial class SettingsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Settings] WHERE (([Id] = @Original_Id) AND ((@IsNull_settingNa" +
                "me = 1 AND [settingName] IS NULL) OR ([settingName] = @Original_settingName)) AN" +
                "D ((@IsNull_value = 1 AND [value] IS NULL) OR ([value] = @Original_value)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Settings] ([Id], [settingName], [value]) VALUES (@Id, @setting" +
                "Name, @value);\r\nSELECT Id, settingName, value FROM Settings WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Settings] SET [Id] = @Id, [settingName] = @settingName, [value] = @value WHERE (([Id] = @Original_Id) AND ((@IsNull_settingName = 1 AND [settingName] IS NULL) OR ([settingName] = @Original_settingName)) AND ((@IsNull_value = 1 AND [value] IS NULL) OR ([value] = @Original_value)));
SELECT Id, settingName, value FROM Settings WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ClientControl_LagunaDelMar.Properties.Settings.Default.SettingsDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, settingName, value FROM dbo.Settings";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT        value\r\nFROM            Settings\r\nWHERE        (settingName = @setti" +
                "ngName)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@settingName", global::System.Data.SqlDbType.VarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "settingName", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "UPDATE       Settings\r\nSET                value = @value\r\nWHERE        (settingNa" +
                "me = @settingName);  \r\nSELECT Id, settingName, value FROM Settings WHERE (settin" +
                "gName  = @settingName)";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@value", global::System.Data.SqlDbType.VarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "value", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@settingName", global::System.Data.SqlDbType.VarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "settingName", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        }
        ...
        public virtual int Fill(DSSettings.SettingsDataTable dataTable) {
        ...
        public virtual DSSettings.SettingsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DSSettings.SettingsDataTable dataTable = new DSSettings.SettingsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DSSettings.SettingsDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DSSettings dataSet) {
        ...
        public virtual int Delete(int Original_Id, string Original_settingName, string Original_value) {
        ...
        public virtual int Insert(int Id, string settingName, string value) {
        ...
        public virtual int Update(int Id, string settingName, string value, int Original_Id, string Original_settingName, string Original_value) {
            ...
            if ((Original_settingName == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[5].Value = ((string)(Original_settingName));
            }
            if ((Original_value == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string settingName, string value, int Original_Id, string Original_settingName, string Original_value) {
            return this.Update(Original_Id, settingName, value, Original_Id, Original_settingName, Original_value);
        }
        
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual string getSettingByName(string settingName) {
        ...
        public virtual int UpdateQueryBySettingName(string value, string settingName) {
            ...
            if ((settingName == null)) {
                ...
                command.Parameters[1].Value = ((string)(settingName));
            }
            global::System.Data.ConnectionState previousConnectionState = command.Connection.State;
            if (((command.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
    ...
    public partial class TableAdapterManager : global::System.ComponentModel.Component {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        private int UpdateUpdatedRows(DSSettings dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._settingsTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        private int UpdateInsertedRows(DSSettings dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._settingsTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        private int UpdateDeletedRows(DSSettings dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows) {
            int result = 0;
            if ((this._settingsTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        public virtual int UpdateAll(DSSettings dataSet) {
            if ((dataSet == null)) {
